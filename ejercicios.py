...
5
else:mascota = input("que mascota tienes: ")
mascota = mascota.lower()

if mascota == "perro":
    print("te recomiendo darle hot chaw")

elif mascota == "gato":
    print("te recomiendo darle concentado")

elif mascota == "coejo":
    print("te recomiendo darle zanahoria y lechuga")
...
6
#pedir horas al usurio
horas = int(input("cuantas horas estuvo tu carro en el parqueadero: "))
...
#resultado
print("debe pagar:", total, "pesos")#pedir hora 
hora = int(input("a que hora llegaste (0 - 23): "))
